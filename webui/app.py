...
“”“Anrop till scraper_api (kräver API-nyckel).”””
...
“”“Anrop till scraper_engine (intern, ingen API-nyckel).”””
...
# === Config-routes → scraper_engine:5001 ===
...
try:
resp = engine_request(‘PUT’, f’/config/{config_id}’, json=request.json)
return jsonify(resp.json()), resp.status_code
except Exception as e:
return jsonify({‘error’: str(e)}), 503
...
# === Scrape-trigger → scraper_engine:5001 ===
